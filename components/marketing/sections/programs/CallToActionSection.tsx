    ...
    >
      <div className='mb-10 space-y-6 text-center'>
        <Heading2 lang={language} className='text-white'>
          {translate('marketing.pages.programs.call-to-action.title')}
        </Heading2>

        <Body2 lang={language} className='mx-auto max-w-2xl text-white'>
          {translate('marketing.pages.programs.call-to-action.description')}
        </Body2>
      </div>
      ...
      <div className='flex flex-col items-stretch justify-center gap-4 sm:flex-row sm:items-center sm:justify-center sm:gap-5'>
        <PrimaryCtaLink href={ROUTES.MARKETING.PROGRAMS}>
          ...
          <span className='relative z-10'>
            {translate('marketing.pages.programs.call-to-action.cta.primary')}
          </span>
        ...
        <SecondaryCtaLink href={ROUTES.MARKETING.CONTACT}>
          ...
          <span>
            {translate('marketing.pages.programs.call-to-action.cta.secondary')}
          </span>
