...
function CommandInput({
  ...
  return (
    <div
      ...
      className='border-input flex h-12 min-h-12 shrink-0 items-center gap-2.5 border-b px-3'
    >
      <SearchIcon className='size-4.5 shrink-0 opacity-50' />
      <CommandPrimitive.Input
        data-slot='command-input'
        className={cn(
          'placeholder:text-muted-foreground flex h-11 min-h-0 w-full flex-1 rounded-md bg-transparent py-2 text-base outline-hidden disabled:cursor-not-allowed disabled:opacity-50 md:text-sm',
          className,
        )}
        {...props}
      />
