  ...
  switch (variant) {
    ...
    default:
      return {
        ...
        description: 'Please wait a moment while we securely verify your access.',
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background">
      ...
      <div className="relative z-10 w-full max-w-sm px-4">
        <div className="bg-card/80 border-border shadow-xl shadow-black/5 relative overflow-hidden rounded-2xl border backdrop-blur-xl">
          {/* Top accent bar */}
          ...
          <div className="space-y-6 px-6 pb-6 pt-5">
            ...
            <div className="flex items-center justify-between gap-3">
              <div className="bg-secondary/70 text-secondary-foreground inline-flex items-center gap-2 rounded-full px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.18em]">
                <span className="bg-primary inline-block h-1.5 w-1.5 animate-pulse rounded-full" />
                <span>{pill}</span>
              </div>
              <div className="flex items-center gap-1.5 text-[10px] font-medium text-muted-foreground">
                <span className="h-1 w-1 rounded-full bg-primary/50" />
                <span className="h-1 w-1 rounded-full bg-primary/40 animation-delay-150 animate-pulse" />
                <span className="h-1 w-1 rounded-full bg-primary/30 animation-delay-300 animate-pulse" />
              </div>
            </div>
          </div>
        </div>
