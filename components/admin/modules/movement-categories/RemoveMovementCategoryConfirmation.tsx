...
export type RemoveMovementCategoryConfirmationProps = {
  open: boolean;
...
export default function RemoveMovementCategoryConfirmation({
  open,
  onOpenChange,
  categoryName,
  isRemoving,
  onConfirm,
}: RemoveMovementCategoryConfirmationProps) {
  const displayName = categoryName?.trim() || 'This movement category';
          ...
          <div className='flex items-start gap-3'>
            ...
            <div className='space-y-1.5'>
              ...
              <AlertDialogDescription className='text-muted-foreground text-[13px] font-medium'>
                ...
                from your movement library. This action cannot be undone.
              </AlertDialogDescription>
            </div>
          </div>
        </AlertDialogHeader>
