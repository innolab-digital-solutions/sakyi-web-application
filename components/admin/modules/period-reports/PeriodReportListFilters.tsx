...
type PeriodReportListFiltersProps = {
  statusFilter: 'all' | ClientPeriodReportListStatus;
  statuses: readonly ClientPeriodReportListStatus[];
  labels: Record<ClientPeriodReportListStatus, string>;
  /** Shown in the “clear filter” row (API default: in review + published). */
  allStatusesMenuLabel: string;
  onClearStatus: () => void;
  onSetStatus: (status: ClientPeriodReportListStatus) => void;
  columns: ReadonlyArray<PeriodReportColumnOption>;
  visibleColumnKeys: readonly string[];
  onToggleColumn: (columnKey: string) => void;
  onResetColumns: () => void;
};

export default function PeriodReportListFilters({
  statusFilter,
  statuses,
  labels,
  allStatusesMenuLabel,
  onClearStatus,
  onSetStatus,
  columns,
  visibleColumnKeys,
