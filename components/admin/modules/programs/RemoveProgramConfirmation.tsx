...
export type RemoveProgramConfirmationProps = {
  open: boolean;
...
export default function RemoveProgramConfirmation({
  open,
  onOpenChange,
  programName,
  isRemoving,
  onConfirm,
}: RemoveProgramConfirmationProps) {
          ...
          <div className='flex items-start gap-3'>
            ...
            <div className='space-y-1.5'>
              ...
              <AlertDialogDescription className='text-muted-foreground text-[13px] font-medium'>
                ...
                from your care program catalog. This action cannot be undone.
              </AlertDialogDescription>
            </div>
          </div>
        </AlertDialogHeader>
