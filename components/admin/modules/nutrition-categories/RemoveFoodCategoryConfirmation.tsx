...
export type RemoveFoodCategoryConfirmationProps = {
  open: boolean;
...
export default function RemoveFoodCategoryConfirmation({
  open,
  onOpenChange,
  categoryName,
  isRemoving,
  onConfirm,
}: RemoveFoodCategoryConfirmationProps) {
