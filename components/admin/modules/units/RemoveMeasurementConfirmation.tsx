...
export type RemoveMeasurementConfirmationProps = {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  /** Display name of the measurement row being removed. */
...
/**
 * Confirms removal of a measurement reference row (matches {@link LogoutConfirmationDialog} chrome).
 */
export default function RemoveMeasurementConfirmation({
  open,
  onOpenChange,
  measurementName,
  isRemoving,
  onConfirm,
}: RemoveMeasurementConfirmationProps) {
