...
import type { EnrollmentContractStatus } from '@/domains/enrollment-contracts/types';

export type EnrollmentContractColumnOption = {
  key: string;
  label: string;
};

type EnrollmentContractFiltersProps = {
  statusFilter: 'all' | EnrollmentContractStatus;
  statuses: readonly EnrollmentContractStatus[];
  labels: Record<EnrollmentContractStatus, string>;
  onClearStatus: () => void;
  onSetStatus: (status: EnrollmentContractStatus) => void;
  columns: readonly EnrollmentContractColumnOption[];
  visibleColumnKeys: readonly string[];
  onToggleColumn: (columnKey: string) => void;
  onResetColumns: () => void;
};

export default function EnrollmentContractFilters({
  statusFilter,
  statuses,
  labels,
  onClearStatus,
  ...
  onToggleColumn,
  onResetColumns,
}: EnrollmentContractFiltersProps) {
