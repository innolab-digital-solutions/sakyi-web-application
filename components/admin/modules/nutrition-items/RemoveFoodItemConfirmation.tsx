...
export type RemoveFoodItemConfirmationProps = {
  open: boolean;
...
export default function RemoveFoodItemConfirmation({
  open,
  onOpenChange,
  itemName,
  isRemoving,
  onConfirm,
}: RemoveFoodItemConfirmationProps) {
          ...
          <div className='flex items-start gap-3'>
            ...
            <div className='space-y-1.5'>
              ...
              <AlertDialogDescription className='text-muted-foreground text-[13px] font-medium'>
                ...
                from your food items library. This action cannot be undone.
              </AlertDialogDescription>
            </div>
          </div>
        </AlertDialogHeader>
