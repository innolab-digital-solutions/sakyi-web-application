...
export type IntakeAssessmentColumnOption = {
  key: string;
  label: string;
};

type IntakeAssessmentFiltersProps<TStatus extends string> = {
  statusFilter: 'all' | TStatus;
  statuses: readonly TStatus[];
  labels: Record<TStatus, string>;
  onClearStatus: () => void;
  onSetStatus: (status: TStatus) => void;
  columns: readonly IntakeAssessmentColumnOption[];
  visibleColumnKeys: readonly string[];
  onToggleColumn: (columnKey: string) => void;
  onResetColumns: () => void;
};

export default function IntakeAssessmentFilters<TStatus extends string>({
  statusFilter,
  statuses,
  labels,
  onClearStatus,
  ...
  onToggleColumn,
  onResetColumns,
}: IntakeAssessmentFiltersProps<TStatus>) {
