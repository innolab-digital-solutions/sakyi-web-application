...
type MovementEquipmentRemovalBlockedAlertProps = {
  open: boolean;
...
export default function MovementEquipmentRemovalBlockedAlert({
  open,
  onOpenChange,
  equipmentName,
  reason,
}: MovementEquipmentRemovalBlockedAlertProps) {
  const displayName = equipmentName?.trim() || 'This equipment';
  const detail =
    reason?.trim() ||
    'This equipment is currently referenced in active records and cannot be removed.';
