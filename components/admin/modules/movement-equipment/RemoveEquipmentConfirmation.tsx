...
export type RemoveEquipmentConfirmationProps = {
  open: boolean;
...
export default function RemoveEquipmentConfirmation({
  open,
  onOpenChange,
  equipmentName,
  isRemoving,
  onConfirm,
}: RemoveEquipmentConfirmationProps) {
  const displayName = equipmentName?.trim() || 'This item';
          ...
          <div className='flex items-start gap-3'>
            ...
            <div className='space-y-1.5'>
              ...
              <AlertDialogDescription className='text-muted-foreground text-[13px] font-medium'>
                ...
                from your movement library. Exercises that reference it may need
