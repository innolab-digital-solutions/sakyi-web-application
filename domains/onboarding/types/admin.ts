// -------------------------------------
// Shared API envelope (from ApiResponseBuilder)
// -------------------------------------
export type ApiSuccess<TData, TMeta extends Record<string, unknown> = Record<string, unknown>> = {
    status: "success";
    message: string;
    data: TData;
    meta: {
  ...
  export type OnboardingIntakeResponse = ApiSuccess<OnboardingIntakeData, Partial<OnboardingProgressMeta>>;
  ...
  export type OnboardingIntakeListResponse = ApiSuccess<OnboardingIntakeData[], PaginationMeta>;